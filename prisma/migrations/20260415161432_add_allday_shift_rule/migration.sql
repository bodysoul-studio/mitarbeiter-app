...
INSERT INTO "new_shift_rules" ("id", "lagMinutes", "leadMinutes", "minStaff", "name", "roleId", "windowEnd", "windowStart") SELECT "id", "lagMinutes", "leadMinutes", "minStaff", "name", "roleId", "windowEnd", "windowStart" FROM "shift_rules";
